...
<h1 style="margin: 1.5em 0 1em;">Rich Front Post Settings</h1>
...
<div style="margin: 0 0 1.5em 0.5em;padding: 0.2em 1.5em;border-left: 0.3em solid darkgray;">
    <span style="font-style: normal;opacity: 0.7;">For more information visit
        <a style="font-style: italic;" href="https://alistat.eu/wordpress/post-right-there" target="_blank">alistat.eu/wordpress/rich-inplace-front-post</a>
    </span><br/>
...
<div id="ipfSettings" style="margin: 0.5em 0 2em;">
    <label for="postTypes">
...
<script>
    <?php $settings= json_encode(ipfGetSettings());  ?>
    ...
    function save(target) {
        ...
        jQuery.ajax({
            type: "POST",
            url: ajaxurl,
            data: {settings: JSON.stringify(vf.getModel(document.getElementById('ipfSettings'))), action:"ipf_save_settings"},
